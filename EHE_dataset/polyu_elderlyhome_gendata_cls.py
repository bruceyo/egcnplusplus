...
files_ = os.listdir('/mnt/nas/ntu-rgbd/PolyU_RGBD/elderlyhome/skeleton')
...
def gendata(data_path,
    ...
    for filename in files_:
        ...
        training_list_label.append(action_class-1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/mnt/nas/ntu-rgbd/PolyU_RGBD/elderlyhome/skeleton')
    parser.add_argument('--out_folder', default='/media/bruce/m2/elderlyhome/cls/ang')
